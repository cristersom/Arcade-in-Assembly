...
.enemy_reset_skip:
    ...
    ; --- IN?CIO DA MODIFICA??O ---
    add word ptr [score], 10    ; Adiciona 10 pontos ao score [Source: 104]
...
atualiza_tempo_hud proc
    ...
    mov al,0h
    xor bh,bh
    mov bl,15 ; <-- CORRIGIDO: Cor Branca (15 ou 0Fh)
    mov cx,TAM_MSG6
    mov dh,0
    mov dl,78
    int 10h
...
fase1_inicio endp ; <--- ADICIONADO O ENDP QUE FALTAVA
